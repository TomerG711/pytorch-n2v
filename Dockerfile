...
CMD python main.py --mode train --name_data 400_gray_npy --dir_data ./datasets --dir_log ./log \
...
#
#CMD python main.py --mode test --name_data 400_gray_npy --dir_data ./datasets --dir_log ./log \
